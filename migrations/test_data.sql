insert into amazon.users (`name`, username, `password`, role_type, delivery_address)
values ('Kirill', 'eertree', 'qwe1', 'admin', 'Pafos'),
       ('Vseslav', 'muslim228', 'qwe2', default, 'Pafos'),
       ('Dima', 'loloshka', 'qwe3', default, 'Saint P.'),
       ('Egor', 'traher1337', 'qwe4', default, '293'),
       ('KanaX', 'foo', 'bar', default, '239');
...
insert into amazon.orders (book_id, user_id)
values (1, 1),
       (2, 1),
       (3, 1),
       (4, 2),
